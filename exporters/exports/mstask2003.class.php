...
class MSTask2003 extends MSObject
{
  ...
  protected function dumpPredecessorLinks()
  {
  ...
  protected function dumpTaskLogs()
  {
    $task = new CTask();
  ...
  protected function dumpDurationDataTypeForTask($duration)
  {
    if ($duration <= 0) {
        return "PT0H0M0S";
    }
  ...
  protected function dumpTaskHoursWorked() 
  {
  ...
  protected function dumpTaskDurationFormat()
  {
