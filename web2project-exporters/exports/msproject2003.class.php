...
class MSProject2003 extends MSObject
{
  ...
  protected function dumpTasksTree(&$taskstree, &$tasks)
  {
  ...
  protected function dumpProjectSummaryTask()
  {
    $task = array (
      'task_id' => 0,
      'task_parent' => 0,
      ...
      'task_updated' => $this->project['project_updated'],
      'task_start_date' => $this->project['project_start_date'],
      'task_end_date' => $this->project['project_end_date'],
      'task_actual_end_date' => $this->project['project_actual_end_date'],
  ...
  protected function dumpResources()
  {
    $resources = array();
  ...
  protected function dumpAssignments()
  {
    $assignments = array();
